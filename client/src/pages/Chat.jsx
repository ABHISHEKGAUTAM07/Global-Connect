...
useEffect(() => {
  ...
  socket.connect();
  socket.emit('join', user._id); // ✅ Sirf yahan
  ...
  // DON'T do optimistic setChats here — wait for 'newMessage' from server
  setText('');
};
      ...
      <div className="col-span-1 border-r overflow-y-auto p-4 bg-gray-100">
        ...
        {users.map((u) => (
          <div
            ...
            className={`p-2 rounded cursor-pointer hover:bg-blue-100 ${selectedUser?._id === u._id ? 'bg-blue-200' : ''
              }`}
          >
